...
from aiecs.tools.office_tool.core.storage import is_object_storage_path
...
async def _script_to_url_storage(script: str) -> str:
    ...
    from aiecs.tools.office_tool.core.storage import resolve_fetch_url, upload_to_storage
