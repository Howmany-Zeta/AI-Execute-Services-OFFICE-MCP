"""office_merge_presentations — merge presentation files."""
...
TOOL_NAME = "office_merge_presentations"
...
async def office_merge_presentations(
    output_path: str,
    ...
    **kwargs: Any,
    ...
    try:
        args = PresentationMergeArgs.model_validate(
            {
...
handler = office_merge_presentations

__all__ = ["TOOL_NAME", "TOOL_DEF", "handler", "office_merge_presentations"]
