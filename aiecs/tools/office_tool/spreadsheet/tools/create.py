...
from aiecs.tools.office_tool.spreadsheet.schemas.workbook_spec import (
    SPREADSHEET_CREATE_INPUT_SCHEMA,
    SpreadsheetCreateArgs,
)
...
TOOL_DEF = {
    ...
    "inputSchema": SPREADSHEET_CREATE_INPUT_SCHEMA,
}
    ...
    **kwargs: Any,
    ...
    try:
        args = SpreadsheetCreateArgs.model_validate(
            {"sheets": sheets, "output_path": output_path, **kwargs}
        )
    ...
    script = build_create_script(args.sheets, output_ext=output_ext)
